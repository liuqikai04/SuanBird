...
- `sticker-emoji-creature`
  White-background sticker-pack meme creature with bubbles and emoji accents.
- `scratchboard-night-creature`
  Dark scratchboard underground-poster satire creature.

### Style archive

For higher-level style understanding, also read:
...
- visual core
- suitable complaint topics
- common failure modes
- whether the style has already been validated with the current Volcengine model
...
- `run-fifth-template-read-test.mjs`
- `run-sixth-template-blame-test.mjs`
