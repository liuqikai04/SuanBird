...
const outputJson = String.raw`C:\Users\user\Documents\task\fusion-noise-style-v2-result.json`;
const outputImage = String.raw`C:\Users\user\Documents\task\fusion-noise-style-v2-result.jpeg`;
